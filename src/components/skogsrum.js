        ...
        return (
            <div id={this.skogsrum.id} className="skogsrum">
                ...
                <div className="wrapper">
                    ...
                    <Dateselector key={this.props.date} range={true} caption={true} unavailableDates={this.skogsrum.unavailableDates} dateCallback={this.dateSelected} date={this.props.date} minDate={new Date(this.skogsrum.earliest)} maxDate={new Date(this.skogsrum.latest)} />
                </div>    
            </div>
        );   
    }

...
class App extends React.Component {
  ...
  handleBookableChange(data) {
    ...
    let formattedProduct = newState.map((selected, i) => {
      return ({"id": selected.id, "quantity": selected.data.quantity, "startDate": selected.data.date[0].toISOString(), "endDate": selected.data.date[1].toISOString()})
    });
